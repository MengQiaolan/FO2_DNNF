        ...
        for cell_pair, rels in self.rels_of_cells.items():
            ...
            for break_block, rels in block_to_rel.items():
                ...
                for element_pair in product(self.domain, repeat=2):
                    ...
                    #     (e_2, e_1) in self.subcircuit_of_rels[cell_pair][break_block].keys():
                    #     self.subcircuit_of_rels[cell_pair][break_block][element_pair] = self.subcircuit_of_rels[cell_pair][break_block][(e_2, e_1)]
                    #     self.expression_of_rels[cell_pair][break_block][element_pair] = self.expression_of_rels[cell_pair][break_block][(e_2, e_1)]
                    #     continue
                    and_node = create_node(NodeType.AND)
                    ...
                    self.subcircuit_of_rels[cell_pair][break_block][element_pair] = and_node.index
